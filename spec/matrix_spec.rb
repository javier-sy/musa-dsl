...
RSpec.describe Musa::Matrix do
  context 'Multidim matrix processing' do
    it 'Multidim matrix to set of P' do
      ...
      expect(m.to_p(time_dimension: 0, keep_time: true)).to eq \
    ...
    it 'Multidim matrix to set of P without keeping time dimension' do
      ...
      expect(m.to_p(time_dimension: 0)).to eq \
    ...
    it 'Multidim matrix rotated to set of P' do
      ...
      mr = mr.to_p(time_dimension: 0, keep_time: true)
    ...
    it 'Multidim matrix set of 2 condensing begin-end' do
      ...
      expect(mm.to_p(time_dimension: 0, keep_time: true)).to eq \
    ...
    it 'bugfix for runtime error on 3d matrix going forward and back in time' do
      ...
      expect { m.to_p(time_dimension: 2) }.not_to raise_error
    end
  end
end
