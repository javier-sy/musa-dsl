...
RSpec.describe Musa::Neumalang do
  ...
  context "Neuma advanced parsing" do
    ...
    it "Basic bracketed neuma inline parsing" do
      expect(Neumalang.parse('2.3.4 5.6.7 [ 9.8.7 6.5.4 ] ::evento # comentario 1').to_a(recursive: true)).to eq(
    ...
    it "Basic bracketed neuma inline recursive parsing" do
      expect(Neumalang.parse('2.3.4 5.6.7 [ 9.8.7 [5.4.5 6.5.6] 6.5.4 [ 5.4.3]] ::evento # comentario 1').to_a(recursive: true)).to eq(
        [   { kind: :neuma, neuma: ["2", "3", "4"] },
          { kind: :neuma, neuma: ["5", "6", "7"] },
          { kind: :serie, serie: [
